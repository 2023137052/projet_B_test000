...
public class PlayerController : MonoBehaviour
{
    ...
    Vector3 velocity;                                           //이돈 방향 벡터 값 선언
    ...
    void Update()
    {
        //모니터 2D -> 인게임 3D 죄표 변환 (마우스가 3D 상에 어디에 있는지)
    ...
    private void FixedUpdate()
    {
        ...
        //GetComponent -> 소스가 있는 게임오브젝트에서 <>안에 있는 컴퍼넌트 접근
        //접근을 한 후에 계산 된 이동 위치 값을 MovePoisition 함수에 적용 
    }
}
